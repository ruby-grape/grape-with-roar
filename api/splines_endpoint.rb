    ...
    class SplinesEndpoint < Grape::API
      ...
      namespace :splines do
        ...
        params do
          ...
          optional :size, type: Integer, default: 10, desc: 'Number of splines to return.'
        end
        get do
          present paginate_by_cursor(Acme::Models::Spline), with: Acme::Api::Presenters::SplinesPresenter
        end
      end
    end
  end
